...
const certifications = [
  {
    title: 'React Stack Course',
    body: 'NxtWave Academy',
    desc: 'Completed a structured intensive training program in scalable full-stack development, where I builtproduction-ready MERN stack applications using modular backend architecture and RESTful APIs.',
    image: './assets/react-cer.png',
    link: 'https://drive.google.com/file/d/1jJTEcJdMeWhM_vO5NJ6m2BxI-Q2W-ZyT/view?usp=drive_link',
  },
  {
    title: 'Cloud Computing Course',
    body: 'NPTEL',
    desc:'This course builds a systems-level understanding of how modern digital infrastructure is designed, deployed, and scaled in the cloud. It moves beyond theory into the architectural thinking required to engineer resilient, elastic, and cost-efficient platforms.',
    image: './assets/cloud-cer.png',
    link: 'https://drive.google.com/file/d/1qKowlsFK0gzFFJ1gLKBveg8SdsamEFC2/view?usp=drive_link',
  },
];
